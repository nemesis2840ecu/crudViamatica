...
import com.viamaica.crud.crud.services.IRol_Rol_OpcionesServices;

@RestController
@RequestMapping("/Rol_Rol_Opciones")
@CrossOrigin( origins = "http://localhost:4200")
public class Rol_Rol_OpcionesController {
	
	//@Qualifier("ClienteService")
	@Autowired
	private IRol_Rol_OpcionesServices _Service;
	...
	@GetMapping("/show/{id}")
	public Rol_Rol_OpcionesModel show(@PathVariable Long id) {
	...
	public Rol_Rol_OpcionesModel create(@RequestBody Rol_Rol_OpcionesModel model) {
	...
	@ResponseStatus(HttpStatus.CREATED)
	public Rol_Rol_OpcionesModel update(@RequestBody Rol_Rol_OpcionesModel model, @PathVariable Long id) {
		
		Rol_Rol_OpcionesModel currentPersona = this._Service.findById(id);
